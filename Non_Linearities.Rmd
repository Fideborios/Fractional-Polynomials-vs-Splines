...
First we present the results for the aforementioned approaches on the simulated IPD-sets and subsequently the results for the empirical data-sets. We start with two-stage approaches and then uisng one-stage approach. 

# 4.1 Two-stage results
## 4.1.1 Basis cubic splines
...
```{r Script for smoothing splines }
...
## 4.1.2 Penalised splines

```{r Script for Penalised splines }
