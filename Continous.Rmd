...
In the Gevers et al . data-set we increased the level of significance into α =0.3 , due to small sample size per trial.
...
* 	GAM approach identifies the point where E( Y┴^_treated-Y┴^_control±1.96×SE_(Y_treated-Y┴^_control )) crosses 0. This measure can be further developed (ideas are welcome) for example, the percentage of the wrongly treated (Joanna’s idea), posterior confidence bands (Bayesian approach)
