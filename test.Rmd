...
B-splines are piece-wise polynomials connected over the knots in order to be continuous. Therefore, B-splines can be of any polynomial degree. For instance, linear B-splines consist of $\kappa$ linear pieces, quadratic of $\kappa$ quadratic pieces cubic of $\kappa$ qubic pieces etc. The general statistical model for a B-spline of Q degree for each trial **j** is:
